...
import {
  ...
  __spreadValues,
  __superGet
} from "./chunk-TM47R3PI.js";

// node_modules/@angular/fire/node_modules/firebase/node_modules/@firebase/app-check/node_modules/@firebase/component/dist/esm/index.esm.js
var Component = class {
  /**
   *
...
// node_modules/@angular/fire/node_modules/firebase/node_modules/@firebase/app-check/node_modules/@firebase/logger/dist/esm/index.esm.js
var instances = [];
var LogLevel;
(function(LogLevel4) {
...
// node_modules/@angular/fire/node_modules/firebase/node_modules/@firebase/app-check/dist/esm/index.esm.js
...
// node_modules/@angular/fire/node_modules/firebase/node_modules/@firebase/auth/node_modules/@firebase/logger/dist/esm/index.esm.js
var instances3 = [];
var LogLevel3;
(function(LogLevel4) {
  LogLevel4[LogLevel4["DEBUG"] = 0] = "DEBUG";
...
var defaultLogLevel3 = LogLevel3.INFO;
var ConsoleMethod3 = {
  [LogLevel3.DEBUG]: "log",
...
var defaultLogHandler3 = (instance, logType, ...args) => {
  if (logType < instance.logLevel) {
    return;
  }
  const now = (/* @__PURE__ */ new Date()).toISOString();
  const method = ConsoleMethod3[logType];
  if (method) {
    console[method](`[${now}]  ${instance.name}:`, ...args);
  } else {
    throw new Error(`Attempted to log a message with an invalid logType (value: ${logType})`);
...
var Logger3 = class {
  ...
  constructor(name5) {
    this.name = name5;
    this._logLevel = defaultLogLevel3;
    this._logHandler = defaultLogHandler3;
    this._userLogHandler = null;
    instances3.push(this);
  }
  get logLevel() {
    return this._logLevel;
  }
  ...
  // Workaround for setter/getter having to be the same type.
  setLogLevel(val) {
    this._logLevel = typeof val === "string" ? levelStringToEnum3[val] : val;
  }
  get logHandler() {
    return this._logHandler;
  }
...
// node_modules/@angular/fire/node_modules/firebase/node_modules/@firebase/auth/node_modules/@firebase/component/dist/esm/index.esm.js
...
// node_modules/@angular/fire/node_modules/firebase/node_modules/@firebase/auth/dist/esm/index-3398f4bb.js
var FactorId2 = {
...
var logClient2 = new Logger3("@firebase/auth");
function _logWarn2(msg, ...args) {
  if (logClient2.logLevel <= LogLevel3.WARN) {
    logClient2.warn(`Auth (${SDK_VERSION}): ${msg}`, ...args);
  }
}
function _logError2(msg, ...args) {
  if (logClient2.logLevel <= LogLevel3.ERROR) {
...
//# sourceMappingURL=chunk-U6ITUY2P.js.map
